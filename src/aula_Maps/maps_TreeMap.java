...
public class maps_TreeMap {
    public static void main(String[] args) {
        ...
        TreeMap<String, String> treeCapitais = new TreeMap<>(); // mantém ordem própria
        //parecido com ordem do set, mas inclui na chave do mapa
        ...
        //Retorna a primeira capital abaixo da árvore parametizada
        ...
        //Retona todas as capitais
        System.out.println(treeCapitais);

        Map.Entry<String, String> firstEntry = treeCapitais.pollFirstEntry();
        Map.Entry<String, String> lastEntry = treeCapitais.pollLastEntry();

        //Retorna a primeira capital do topo da árvore, removendo do mapa
